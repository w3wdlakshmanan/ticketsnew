<template>
  <div class="">
    ...
    >
      ...
      >
        <div class="modal-content text-left h-full p-2 md:p-3">
          <div class="">
            <div
          ...
          <div class=" overflow-y-auto">
            <div class="">
              ...
              <input
                ...
                type="text"
                class="py-3 mt-2 md:mt-3 shadow-sm px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                placeholder="Subject"
              />

              <textEditor @create-descript="createDescriptText" class="mt-2 md:mt-3"/>
          ...
          <div class="flex justify-end items-center gap-x-2 mt-2 md:mt-3 ">
            <button
              @click="createTicket"
        ...
        <div class="modal-content py-4 text-left h-full">
          <div v-if="loader == false">
            <div
              ...
              :class="statusData?.status == 'ok' ? 'py-4' : 'py-0'"
            >
              <svg
            ...
            <div
              ...
              :class="statusData?.status == 'error' ? 'text-red-500' : null"
            >
...
formData.append("subCat",this.selectedSubCategory);
    ...
    async uploadImage(this: { selectedFileName: any; file: any }, event: any) {
    ...
    getDep() {
      this.allDepartMentData.forEach((each) => {
    ...
    selectCategory(data) {
      ...
      this.departmentIndex = this.allDepartMentData.findIndex(
        (obj) => Object.keys(obj)[0] === this.selectedCategory
      );

      const selectedDepartment = this.allDepartMentData.find((department) => {
