  ...
  <div>
    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
      <div id="hs-open-editor">
        ...
        <div
          class="h-[10rem] overflow-auto text-sm"
          ref="editor"
          data-hs-open-field=""
        ></div>
      </div>
...
export default {
  mounted() {
    const editor = new Editor({
      ...
      onUpdate: ({ editor }) => {
        ...
        this.updateContent(editor.getHTML());
      },
    });

    const actions = [
      {
        id: "[data-hs-open-bold]",
        fn: () => editor.chain().focus().toggleBold().run(),
      },
      {
        id: "[data-hs-open-italic]",
        fn: () => editor.chain().focus().toggleItalic().run(),
      },
      {
        id: "[data-hs-open-underline]",
        fn: () => editor.chain().focus().toggleUnderline().run(),
      },
      {
        id: "[data-hs-open-strike]",
        fn: () => editor.chain().focus().toggleStrike().run(),
      },
      {
        id: "[data-hs-open-link]",
        fn: () => {
      ...
      {
        id: "[data-hs-open-blockquote]",
        fn: () => editor.chain().focus().toggleBlockquote().run(),
      },
      {
        id: "[data-hs-open-code]",
  ...
  methods: {
    updateContent(this: { content: any,$emit:Function }, html: string) {
      this.content = html;
      this.$emit('open-ticket-content',this.content)
    },
    async saveContentToAPI(this: { editor: any }) {
